        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StripeLastEventId = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Cotizaciones_CotizacionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_ClientId_Status_CreationDate",
                table: "Payments",
                columns: new[] { "ClientId", "Status", "CreationDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Payments_CotizacionId",
                table: "Payments",
                column: "CotizacionId",
                unique: true,
